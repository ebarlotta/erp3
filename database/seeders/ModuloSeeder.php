...
class ModuloSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('modulos')->insert(['name' => 'Compras-Ventas-Mini', 'pagina' => 'compras-mini','imagen'=>'Compras-Ventas-Mini.jpg','leyenda'=>'Registre todos los comprobantes de las compras/gastos realizados. Ingrese al stock los productos adquiridos.','habilitado'=>1]);   //erp
