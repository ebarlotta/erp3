...
=======
        ...
        DB::table('modulos')->insert(['name' => 'Nacionalidad', 'pagina' => 'nacionalidad','imagen'=>'nacionalidad.jpg','leyenda'=>'Gestione distintos tipos de Nacionalidades dentro del sistema.','habilitado'=>1]); // 15
        DB::table('modulos')->insert(['name' => 'Provincias', 'pagina' => 'provincias','imagen'=>'provincias.jpg','leyenda'=>'Gestione distintas Provincias dentro del sistema.','habilitado'=>1]); // 16
        DB::table('modulos')->insert(['name' => 'Actores', 'pagina' => 'actores','imagen'=>'actores.jpg','leyenda'=>'En este módulo se podrán gestionar todos los actores que participan en el sistema, tales como Clientes, Proveedores, Empleados.','habilitado'=>1]); //17
        DB::table('modulos')->insert(['name' => 'Listas', 'pagina' => 'listas','imagen'=>'listas.jpg','leyenda'=>'Cree, modifique y elimine listas de precios para distintos tipos de clientes','habilitado'=>1]); // 18
        DB::table('modulos')->insert(['name' => 'Categorías Profesionales', 'pagina' => 'categoriaprofesional','imagen'=>'categoriaprofesional.jpg','leyenda'=>'Gestiona las categorías profesionales de los empleados','habilitado'=>1]); // 19
        DB::table('modulos')->insert(['name' => 'Beneficios', 'pagina' => 'beneficios','imagen'=>'beneficios.jpg','leyenda'=>'Gestiona los distintos tipos de beneficios/obras sociales','habilitado'=>1]); // 20
        DB::table('modulos')->insert(['name' => 'Escolaridades', 'pagina' => 'escolaridades','imagen'=>'escolaridades.jpg','leyenda'=>'Gestiona las escolaridades de las personas','habilitado'=>1]); // 21
...
=======
        ...
        DB::table('modulos')->insert(['name' => 'Interfaces', 'pagina' => 'interfaces','imagen'=>'interfaces.jpg','leyenda'=>'Generación de interfaces necesarias para la aplicación diseñada.','habilitado'=>1]);    // Geri 42
        DB::table('modulos')->insert(['name' => 'Medicamentos', 'pagina' => 'medicamentos','imagen'=>'medicamentos.jpg','leyenda'=>'Administre nombres y tipos de medicamentos.','habilitado'=>1]);  // Geri 43
        DB::table('modulos')->insert(['name' => 'Menú', 'pagina' => 'menu','imagen'=>'menu.jpg','leyenda'=>'Gestione los distintos menúes a servir.','habilitado'=>1]);    // Geri 44
        DB::table('modulos')->insert(['name' => 'Motivo de Egreso', 'pagina' => 'motivoegreso','imagen'=>'egresos.jpg','leyenda'=>'Diversos motivos por los cuales la persona no continua en el lugar.','habilitado'=>1]);    // Geri 45
        DB::table('modulos')->insert(['name' => 'Personas Campos', 'pagina' => 'personascampos','imagen'=>'haberes.jpg','leyenda'=>'Distintintos campos utilizados a una persona.','habilitado'=>1]);   // Geri 46
        DB::table('modulos')->insert(['name' => 'otrascosas', 'pagina' => 'otrascosas','imagen'=>'haberes.jpg','leyenda'=>'Otras cosas.','habilitado'=>1]);    // Geri 47
        DB::table('modulos')->insert(['name' => 'Perfil', 'pagina' => 'profile','imagen'=>'haberes.jpg','leyenda'=>'Modifique los datos personales.','habilitado'=>1]);   // Geri 48
        DB::table('modulos')->insert(['name' => 'Tipos de Personas', 'pagina' => 'tiposdepersonas','imagen'=>'tiposdepersonas.jpg','leyenda'=>'Administra los distintos actores/personas dentro del sistema.','habilitado'=>1]);   // Geri 49
        DB::table('modulos')->insert(['name' => 'Planes Alimentarios', 'pagina' => 'planalimentario','imagen'=>'planalimentario.jpg','leyenda'=>'Administra los distintos Planes alimentarios de la institución.','habilitado'=>1]);   // Geri 50
        DB::table('modulos')->insert(['name' => 'Expendio', 'pagina' => 'expendio','imagen'=>'expendio.jpg','leyenda'=>'Administra el expendio de los menúes.','habilitado'=>1]);   // Geri 51

        // Módulos 52-54  --- IMPRENTA
        DB::table('modulos')->insert(['name' => 'Pedidos', 'pagina' => 'imprentapedidos','imagen'=>'pedido.jpg','leyenda'=>'Gestiona los pedidos de clientes','habilitado'=>1]);   // 52
        DB::table('modulos')->insert(['name' => 'Envíos', 'pagina' => 'imprentaenvios','imagen'=>'envio.jpg','leyenda'=>'Gestiona los envíos.','habilitado'=>1]);   // 53
        DB::table('modulos')->insert(['name' => 'Administración Imprenta', 'pagina' => 'imprentaadmin','imagen'=>'administracion.jpg','leyenda'=>'Administra la Imprenta/Centro de Copiado.','habilitado'=>1]);   // 54

        // Módulos 55-59       Carrito
        DB::table('modulos')->insert(['name' => 'Agregar Etiqueta', 'pagina' => 'producto/tag','imagen'=>'administracion.jpg','leyenda'=>'Agrega Etiqueta.','habilitado'=>1]);   // 55
        DB::table('modulos')->insert(['name' => 'Agregar Producto', 'pagina' => 'producto/create','imagen'=>'administracion.jpg','leyenda'=>'Agrega Producto.','habilitado'=>1]);   // 56
        DB::table('modulos')->insert(['name' => 'Modificar / Eliminar', 'pagina' => 'producto','imagen'=>'administracion.jpg','leyenda'=>'Modifica / Elimina Producto.','habilitado'=>1]);   // 57
        DB::table('modulos')->insert(['name' => 'Gestión de Producto', 'pagina' => 'productoscarts','imagen'=>'administracion.jpg','leyenda'=>'Gestiona el Producto.','habilitado'=>1]);   // 58
        DB::table('modulos')->insert(['name' => 'Registrar Bajas', 'pagina' => 'productobajas','imagen'=>'administracion.jpg','leyenda'=>'Registra Bajas','habilitado'=>1]);   // 59
>>>>>>> 943f57fd3aa8f0145940a5477668b16591a578e5
