...
class ModuloSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('modulos')->insert(['name' => 'Actores', 'pagina' => 'actores','imagen'=>'actores.jpg','leyenda'=>'En este módulo se podrán gestionar todos los actores que participan en el sistema, tales como Cliente, Proveedores, Empleados.','habilitado'=>1]); // 17
