...
class ModuloSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // DB::table('modulos')->insert(['name' => 'Informes', 'pagina' => 'tablasver','imagen'=>'informes.jpg','leyenda'=>'Genere informes resumidos de los movimientos de compras, ventas y demás. Son herramientas empresariales claves para la gestión de su empresa.']);
        ...
        DB::table('modulos')->insert(['name' => 'Nacionalidades', 'pagina' => 'nacionalidad','imagen'=>'unidades.jpg','leyenda'=>'Permite individualizar a cada producto con sus unidades de medida precisa a la hora de tener un control del stock de los mismos.']);
        ...
        DB::table('modulos')->insert(['name' => 'Ha beres', 'pagina' => 'haberes','imagen'=>'haberes.jpg','leyenda'=>'Calcule las liquidaciones de haberes de su personal. Revise liquidaciones de períodos anteriores.']);
