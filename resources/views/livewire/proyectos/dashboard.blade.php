...
<div class="flex min-h-screen">
     <aside class="w-64 bg-slate-900 border-r border-slate-800 flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <a href="#" class="sidebar-item flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-slate-800">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <header class="flex items-center justify-between mb-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <!-- Filters -->
            <select
                wire:model.live="statusFilter" class="bg-slate-800 border border-slate-700 rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500">
